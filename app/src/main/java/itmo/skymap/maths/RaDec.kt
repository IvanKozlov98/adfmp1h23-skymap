package itmo.skymap.maths

import com.example.math_module.TimeMachine
import itmo.skymap.maths.coords.HeliocentricCoordinates
import itmo.skymap.maths.coords.LatLong
import itmo.skymap.navigator.maths.RADIANS_TO_DEGREES
import itmo.skymap.navigator.maths.mod
import itmo.skymap.navigator.rendertype.Planet
import itmo.skymap.navigator.rendertype.Planet.Companion.getMoonPosition
import java.util.*
